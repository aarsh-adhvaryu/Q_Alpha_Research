...
Solves the **same** :class:`~research.quantum.qubo.PortfolioQUBO` as the classical baselines, on a
...
optimality gap vs :func:`~research.quantum.solvers.solve_exact` rather than assume it matches. This is
...
from research.quantum.qubo import IntArray, PortfolioQUBO, qubo_energy
