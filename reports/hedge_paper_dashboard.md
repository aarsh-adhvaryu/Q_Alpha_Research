...
_Forward paper overlay of the Sprint-2 gauge-triggered short-futures hedge on a passive NIFTY book — **no real derivatives traded**. Validated config: τ=0.7, persist=5, h=0.5. As of **2026-08-18** (started 2026-06-19)._

## Gauge & hedge state now

| | |
|---|---|
| Systemic-stress gauge | 🟢 **0.32** (calm) |
| Hedge state | **— hedge off** |
| Forward paper days | 43 |
...
| Book | Return | Final |
|---|---|---|
| Unhedged NIFTY | -0.05% | 0.9995 |
| Hedged (paper) | -0.05% | 0.9995 |
