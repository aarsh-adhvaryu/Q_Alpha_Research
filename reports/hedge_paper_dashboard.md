...
_Forward paper overlay of the Sprint-2 gauge-triggered short-futures hedge on a passive NIFTY book — **no real derivatives traded**. Validated config: τ=0.7, persist=5, h=0.5. As of **2026-07-01** (started 2026-06-19)._
...
| Book | Return | Final |
|---|---|---|
| Unhedged NIFTY | -0.67% | 0.9933 |
| Hedged (paper) | -0.67% | 0.9933 |
